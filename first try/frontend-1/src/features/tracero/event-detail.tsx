        ...
        <div className='flex min-w-0 items-center gap-2'>
          ...
          <div className='min-w-0'>
            ...
            <div className='flex min-w-0 items-center gap-2'>
              ...
              {(run.provider_type || run.data_source) && (
                <Badge variant='outline' className='shrink-0'>
                  {run.provider_type ?? 'unknown'} /{' '}
                  {run.data_source ?? 'unknown'}
                </Badge>
              )}
                ...
                <CardContent className='min-h-0 flex-1 overflow-hidden p-0'>
                  <ScrollArea className='h-full'>
                    {run.conclusion ? (
                      ...
                      <p className='p-4 text-sm leading-6 text-destructive'>
                        {run.errors?.join('；') || '本次推理结论未通过校验。'}
                      </p>
                    )}
                  </ScrollArea>
                </CardContent>
